...
const MyInput: React.FC<{show?: boolean, answerWord: string, showAnswer: PropsFn, wordChangeCount: number, playSound: boolean, onSuccess: PropsFn}> = (props) => {
  ...
  function getLetterStyle(letterIndex: number): React.CSSProperties {
    ...
    const isMatching = insertedText.charAt(letterIndex) === props.answerWord.charAt(letterIndex);
